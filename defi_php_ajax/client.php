...
/*### CLIENT LIST ###*/
$sqlClientList = "SELECT id, nom, adresse, date_naissance FROM client";
$sqlShowMore = "SELECT adresse, date_naissance FROM client WHERE id=:id"

$clientList = $bdd->prepare($sqlClientList);
$ShowMore = $bdd->prepare($sqlShowMore);

$clientView->bindParam(':id', $_POST['mailToSuppID'], PDO::PARAM_INT);
$clientList->execute();

// Boucle dans la bdd
$result = $clientList->fetchAll(PDO::FETCH_ASSOC);
